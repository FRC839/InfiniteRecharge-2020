...
{
    private static final CANSparkMax  m_motor = new CANSparkMax( Constants.CAN_Shooter, MotorType.kBrushless );
    ...
    // Use this method if you want to specify a percentage of MAX RPM
    // Valid range:  -1 to 1
